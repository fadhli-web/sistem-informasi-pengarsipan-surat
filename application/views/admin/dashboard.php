                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 col-lg-7">
                        <div class="card shadow mb-4">
                            <!-- Card Header - Dropdown -->
                            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                <h6 class="m-0 font-weight-bold text-success">Laporan Tendik hari ini</h6>
                                <div class="dropdown no-arrow">
                                    <a href="<?= base_url('admin/laporan_tendik') ?>" class="text-dark" style="text-decoration: none">Lihat semua</a>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="laporan_tendik" width="100%" cellspacing="0">
                                        <thead>
                                            <tr>
                                                <th>No.</th>
                                                <th>Nama Laporan</th>
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($sk_today as $sk) : ?>
                                                <tr>
                                                    <td><?= $no++; ?></td>
                                                    <td><?= $sk->nama_laporan; ?></td>
                                                    <td><?= $sk->nama_sekolah; ?></td>
                                                    <td><?= $sk->tingkat_sekolah; ?></td>
                                                    <td><?php $date = date_create($sk->tanggal);
                                                        echo date_format($date, 'd/m/Y'); ?></td>
                                                    <td><?= $sk->keterangan; ?></td>
                                                    <td><a href="<?php echo base_url($user . '/download/' . $sk->berkas_suratkeluar) ?>"><i class="fas fa-download text-success"></i></a></td>
                                                </tr>
